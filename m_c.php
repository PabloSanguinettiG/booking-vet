...
<head>
    ...
    <title>Menú de Clientes - Clínica Veterinaria Happy Feet</title>
    <style>
        body {
...
<body>
    ...
    <button onclick="window.location.href='r_f.php'">Registrar Ficha de Mascota</button>
    <button onclick="window.location.href='r_h.php'">Pedir una Hora</button>
